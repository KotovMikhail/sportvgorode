            ...
            (l.prototype = {
              utils: {
                ...
                triggerCallback: function (t, n) {
                  ...
                  e.isFunction(o) && o.apply(i, a),
                    e(i).trigger(r + "-" + this.toDash(t), a);
                },
              ...
              init: function (t) {
                ...
                if (
                  ...
                  var i = e("<input/>", {
                    ...
                    a = e("<div/>", { class: n.classes.scroll }),
                    s = e("<div/>", {
                      ...
                      if (r.is("optgroup")) {
                        ...
                        r.children().each(function (n) {
                          ...
                          (i.items[n] = t.getItemData(
                            ...
                            (t.lookupItems[a] = i.items[n]),
                            a++;
                        }),
                          (t.items[n] = i);
                      } else (t.items[n] = t.getItemData(a, r, r.prop("disabled"))), (t.lookupItems[a] = t.items[n]), a++;
                    }),
                    t.setLabel(),
              ...
              handleKeys: function (t) {
                var n = this,
                  ...
                  a = e.inArray(r, i.next) > -1,
                  s = e.inArray(r, i.select) > -1,
                  l = e.inArray(r, i.open) > -1,
                  u = n.state.highlightedIdx,
                  c = (o && 0 === u) || (a && u + 1 === n.items.length),
                  p = 0;
                if (((13 !== r && 32 !== r) || t.preventDefault(), o || a)) {
                  if (!n.options.allowWrap && c) return;
                  o && (p = n.utils.previousEnabledItem(n.lookupItems, u)),
                    a && (p = n.utils.nextEnabledItem(n.lookupItems, u)),
                    n.highlight(p);
                }
                if (s && n.state.opened)
                  return (
            ...
            var t = function (t, n, r) {
              var i = {
                ...
                getRegexMask: function () {
                  for (var e, t, r, i, o, s, l = [], u = 0; u < n.length; u++)
                    (e = a.translation[n.charAt(u)])
                ...
                calculateCaretPosition: function (e) {
                  ...
                  if (e !== n) {
                    var o = t.data("mask-previus-caret-pos") || 0,
                      ...
                      p = 0,
                      f = 0;
                    for (f = r; f < a && i.maskDigitPosMap[f]; f++) u++;
                    for (f = r - 1; f >= 0 && i.maskDigitPosMap[f]; f--) l++;
                    for (f = r - 1; f >= 0; f--) i.maskDigitPosMap[f] && c++;
                    for (f = o - 1; f >= 0; f--) i.maskDigitPosMapOld[f] && p++;
                    if (r > s) r = 10 * a;
                    else if (o >= r && o !== s) {
                      if (!i.maskDigitPosMapOld[r]) {
                        var d = r;
                        (r -= p - c), (r -= l), i.maskDigitPosMap[r] && (r = d);
                      }
                    } else r > o && ((r += c - p), (r += u));
                  }
                  return r;
                ...
                getMasked: function (e, t) {
                  ...
                  for (
                    ...
                    k
                      ? (w.match(k.pattern)
                          ...
                          ? ((p += g), (d -= g))
                          : k.fallback
                          ? (u[m](k.fallback), (p += g), (d -= g))
                          : i.invalid.push({ p: d, v: w, e: k.pattern }),
                        (d += g))
                      : (e || u[m](b),
                        w === b
                          ? (x.push(d), (d += g))
                  ...
                  var C = n.charAt(o);
                  f !== h + 1 || a.translation[C] || u.push(C);
                  var T = u.join("");
                ...
                (a.init = function (s) {
                  if (
                    ...
                    for (var l = 0, u = !0; l < n.length; l++) {
                      var c = a.translation[n.charAt(l)];
                      if (c && c.recursive) {
                        u = !1;
                        break;
                      }
      ...
      755: function (e, t) {
        ...
        !(function (t, n) {
              ...
              return (
                ...
                ue(function (o, a, s, l) {
                  var u,
                    ...
                    v = n ? (i || (o ? e : h || r) ? [] : a) : m;
                  if ((n && n(m, v, s, l), r))
                    for (u = ke(v, d), r(u, [], s, l), c = u.length; c--; )
                      (p = u[c]) && (v[d[c]] = !(m[d[c]] = p));
                  if (o) {
                    if (i || e) {
                      if (i) {
              ...
              function (e, t) {
                T.fn[e] = function (n, r) {
                  ...
                  return (
                    ...
                    this.length > 1 &&
                      (H[e] || T.uniqueSort(i), O.test(e) && i.reverse()),
                    this.pushStack(i)
                  );
                };
              }
                  ...
                  i = {
                    ...
                    then: function (e, n, i) {
                      ...
                      return T.Deferred(function (r) {
                        t[0][3].add(a(0, r, v(i) ? i : W, r.notifyWith)),
                          t[1][3].add(a(0, r, v(e) ? e : W)),
                          t[2][3].add(a(0, r, v(n) ? n : $));
                      }).promise();
                    },
                    promise: function (e) {
            ...
            T.extend({
              ...
              ready: function (e) {
                (!0 === e ? --T.readyWait : T.isReady) ||
                  ((T.isReady = !0),
                  (!0 !== e && --T.readyWait > 0) || _.resolveWith(x, [T]));
              },
            }),
            (T.ready.then = _.then),
                ...
                for (u = (t = (t || "").match(R) || [""]).length; u--; )
                  if (
                    ...
                    a &&
                      ...
                      delete l[d]);
                  } else for (d in l) T.event.remove(e, d + t[u], n, r, !0);
          ...
          function $e(e, t, n, r) {
            ...
            if (
              g ||
              (f > 1 && "string" == typeof h && !m.checkClone && Le.test(h))
            )
            ...
            if (
              ...
              for (s = (a = T.map(be(i, "script"), He)).length; p < f; p++)
                (u = i),
                  p !== d &&
                    ((u = T.clone(u, !0, !0)),
              ...
              if (s)
                for (
                  c = a[a.length - 1].ownerDocument, T.map(a, Pe), p = 0;
                  p < s;
                  p++
                )
                  (u = a[p]),
                    ye.test(u.type || "") &&
                      ...
                      (u.src && "module" !== (u.type || "").toLowerCase()
                        ...
                        : w(u.textContent.replace(qe, ""), u, c));
            }
            return e;
          }
          function Be(e, t, n) {
            ...
            T.extend({
              ...
              ajax: function (e, t) {
                ...
                if (
                  ...
                  if (
                    ((C.readyState = 1), c && g.trigger("ajaxSend", [C, d]), u)
                  )
                    return C;
                  d.async &&
                    d.timeout > 0 &&
                    ...
                    p
                      ? (d.ifModified &&
                        ...
                        204 === e || "HEAD" === d.type
                          ...
                          : 304 === e
                          ? (k = "notmodified")
                          : ((k = b.state), (f = b.data), (p = !(x = b.error))))
                      : ((x = k),
                        (!e && k) || ((k = "error"), e < 0 && (e = 0))),
                    (C.status = e),
                    (C.statusText = (t || k) + ""),
                    p
                      ? m.resolveWith(h, [f, k, C])
          ...
          T.ajaxSetup({
            ...
            T.each(["top", "left"], function (e, t) {
              T.cssHooks[t] = Ue(m.pixelPosition, function (e, n) {
                if (n)
                  return (
                    (n = Ge(e, t)), Fe.test(n) ? T(e).position()[t] + "px" : n
                  );
              });
            }),
